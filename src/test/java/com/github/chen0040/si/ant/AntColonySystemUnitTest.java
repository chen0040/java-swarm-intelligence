 ...
 */
public class AntColonySystemUnitTest {

   private static final Logger logger = LoggerFactory.getLogger(AntColonySystemUnitTest.class);
   ...
   public void test_tsp(){
      ...
      logger.info("cost trends: {}", antColonySystem.getCostTrend());
   }
